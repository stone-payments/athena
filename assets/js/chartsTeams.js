  ...
  $('#name').keypress(function(e){
    ...
    $("#find").click(function() {
        ...
        name = $("#name").val();
                    console.log(name);
        $.ajax({
            url: 'http://127.0.0.1:5000/LanguagesOrgTeam?org='+'stone-payments'+'&team='+name,
            type: 'GET',
        ...
        $.ajax({
            ...
            $.ajax({
                url: 'http://127.0.0.1:5000/OpenSourceTeam?org='+'stone-payments'+'&team='+name,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    returnedData = JSON.parse(response);
            ...
            $.ajax({
                url: 'http://127.0.0.1:5000/readmeOrgTeam?org='+'stone-payments'+'&team='+name,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    returnedData = JSON.parse(response);
            ...
            $.ajax({
                url: 'http://127.0.0.1:5000/LicenseTypeTeam?org='+'stone-payments'+'&team='+name,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    returnedData = JSON.parse(response);
